...
MACRO_TUNING_PARAM(ShotgunCurvature, shotgun_curvature, 0, "Shotgun curvature")
...
MACRO_TUNING_PARAM(ShotgunLifetime, shotgun_lifetime, 6.00f, "Shotgun lifetime")
...
MACRO_TUNING_PARAM(HammerFireDelay, hammer_fire_delay, 120, "Delay of hammering (when hitting nothing)")
MACRO_TUNING_PARAM(GunFireDelay, gun_fire_delay, 60, "Delay of firing gun")
