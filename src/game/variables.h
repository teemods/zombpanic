...
MACRO_CONFIG_INT(SvAutoTeamBalance, sv_team_balance, 0, 0, 0, CFGFLAG_SERVER, "Enables autobalancing teams system")
...
MACRO_CONFIG_INT(PanicInvisibilityCooldown, panic_invisibility_cooldown, 35, 1, 9999, CFGFLAG_SERVER, "Cooldown time of invisibility power (seconds)")

MACRO_CONFIG_INT(PanicZombieInitialLife, panic_zombie_initial_life, 400, 1, 9999, CFGFLAG_SERVER, "Initial damage value for hammer player")

MACRO_CONFIG_INT(PanicHammerPlayerInitialDamage, panic_hammer_initial_damage, 10, 1, 9999, CFGFLAG_SERVER, "Initial damage value for hammer player")
MACRO_CONFIG_INT(PanicHammerTurretInitialDamage, panic_hammer_turret_initial_damage, 350, 1, 9999, CFGFLAG_SERVER, "Initial damage value for hammer turret")

MACRO_CONFIG_INT(PanicGunInitialDamage, panic_gun_initial_damage, 3, 1, 9999, CFGFLAG_SERVER, "Initial damage value for the gun")
...
MACRO_CONFIG_INT(PanicGrenadeInitialDamage, panic_grenade_initial_damage, 5, 1, 9999, CFGFLAG_SERVER, "Initial damage value for the grenade")
...
MACRO_CONFIG_INT(PanicGrenadeForceMultiplier, panic_grenade_force_multiplier, 3, 1, 12, CFGFLAG_SERVER, "Grenade force repell multiplier (for zombies damage and grenade human jump)")
...
MACRO_CONFIG_INT(PanicWallDuration, panic_wall_duration, 5, 1, 9999, CFGFLAG_SERVER, "Duration of player laser wall (seconds)")
MACRO_CONFIG_INT(PanicTurretWallDuration, panic_turret_wall_duration, 6, 1, 9999, CFGFLAG_SERVER, "Duration of turret laser wall (seconds)")
...
MACRO_CONFIG_INT(PanicZombieDoorDelay, panic_zombie_door_delay, 3, 1, 9999, CFGFLAG_SERVER, "Delay before zombie doors closes (seconds)")
